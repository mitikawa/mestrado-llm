...
Para superar este desafio, a nossa metodologia (detalhada na Secção \ref{sec:metodo}) emprega uma \textbf{estratégia de agregação}, onde o classificador $M_{SD}$ é aplicado iterativamente às sentenças de um documento $D_{MGTD}$ para calcular um "Índice de Subjetividade" agregado.