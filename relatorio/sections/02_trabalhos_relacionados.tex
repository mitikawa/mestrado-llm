...
Dentre as equipes que participaram da SemEval-2024 Task 8 \cite{wang-etal-2024-semeval-2024}, além dos principais sistemas vencedores terem utilizado majoritariamente arquiteturas de Transformers, foram propostas variações em relação ao modelo tradicional de Vaswani \cite{vaswani2023attentionneed} um dos times que se destacou utilizou variações na arquitetura \cite{guo-etal-2024-ustc}, com uso de Redes Neurais Adaptativas(DANNs) na camada de tokenização, e obtiveram resultados muito competitivos. Esse tipo de variação inspirou o atual trabalho para serem realizados variados experimentos.
