...
Esta discrepância não permite uma comparação direta e constitui um desafio metodológico central. Não podemos aplicar diretamente o classificador $M_{MGTD}$ (treinado em documentos) a uma sentença, nem aplicar o $M_{SD}$ (treinado em sentenças) diretamente a um documento $D_{MGTD}$.
